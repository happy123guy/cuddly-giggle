...
document.getElementById('userSketch').innerHTML = 'Your Sketch - ' + results[0].label;
document.getElementById('sketchCofidence').innerHTML = 'Confidence - ' + Math.round(results[0].confidence * 100) + "%";
}
}
